...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            {
                return; // Checando se o banco de dados já está populado (seeded)
                // A operação Any() do LINQ testa se já tem algum registro na tabela selecionada
            }

            Department d1 = new Department(1, "PC Hardware");
            Department d2 = new Department(2, "Periferics");
            Department d3 = new Department(3, "Chairs");
            Department d4 = new Department(4, "Miscellaneous");
